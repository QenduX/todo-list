...
<template>
  <label class="label">
    <input class="input" @input="onUpdate" :value="value" type="text" :placeholder="placeholder">
    <svg v-if="withIcon" class="icon" width="21" height="22" viewBox="0 0 21 22" fill="none" xmlns="http://www.w3.org/2000/svg">
